// refer to https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/5.1.transformations/transformations.cpp
#include <iostream>
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // https://youtu.be/kUATZinKDv0?list=PL0luF_aDUOooIB56NOFVTS4ahMzBHS_6z&t=3508
